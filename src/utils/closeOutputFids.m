function closeOutputFids(fids, useOptimizedOutputToFile)
%CLOSEOUTPUTFIDS Closes and flushes opened output files given in the fids
%matrix
%
% INPUTS:
...
%
% SEE ALSO: GETQDFILESIDS, PARAMETERCFG
